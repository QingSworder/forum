...
<div class="container">
    <div class="box">
        <div class="talk-item">
            <ul class="topic-type unstyled inline" style="margin-bottom:0px;">
                ...
                <c:forEach items="${nodeList}" var="node">
                    <li><a class="${node.id==param.nodeId?'active':''}" href="/home?nodeId=${node.id}">${node.nodeName}</a></li>
                </c:forEach>
        ...
        <div class="pagination pagination-min pagination-centered">
