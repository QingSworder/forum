    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal" id="basicForm">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="username" value="${sessionScope.curr_user.userName}" readonly>
                </div>
            </div>
            <div class="control-group">
    ...
    <div class="box">
        ...
        <form action="" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <img id="avatar" class="img-circle" alt="">
                </div>
            </div>
            <hr>
        ...
        $.post("/setting?action=avatar",{'fileKey':fileKey})
            .done(function (data) {
                if(data.state=='success'){
                    var url = 'http://oigngl0pa.bkt.clouddn.com/'+fileKey;
